...
data.aws_vpc.default: Read complete after 0s [id=vpc-0bd5ca5c81f3fb1]
data.aws_subnet_ids.subnets: Reading...
data.aws_subnet_ids.subnets: Read complete after 0s [id=vpc-0bd5ca5c81f3fb1]
data.aws_subnet.subnets["subnet-058913b23d9c72"]: Reading...
data.aws_subnet.subnets["subnet-092317f239795c"]: Reading...
data.aws_subnet.subnets["subnet-0b05e8e772705b"]: Reading...
data.aws_subnet.subnets["subnet-049ac40c7fa73e"]: Reading...
data.aws_subnet.subnets["subnet-049ac40c7fa73e"]: Read complete after 0s [id=subnet-049ac40c7fa73e]
data.aws_subnet.subnets["subnet-058913b23d9c72"]: Read complete after 1s [id=subnet-058913b23d9c72]
data.aws_subnet.subnets["subnet-0b05e8e772705b"]: Read complete after 1s [id=subnet-0b05e8e772705b1]
data.aws_subnet.subnets["subnet-092317f239795c"]: Read complete after 1s [id=subnet-092317f239795c6]
 ...
 <= data "aws_iam_policy_document" "ecs_task_execution_policy" {
  ...
  + resource "aws_ecs_service" "my_service" {
      ...
      + network_configuration {
          ...
          + subnets          = [
              + "subnet-049ac40c7fa73e",
              + "subnet-058913b23d9c72",
              + "subnet-092317f239795c",
              + "subnet-0b05e8e772705b",
            ]
        }
    }
